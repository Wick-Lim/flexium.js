...
```
Import from `flexium-canvas/dom`:
```tsx
import { Canvas, DrawRect, DrawCircle } from 'flexium-canvas/dom'
```
:::
...
```tsx
import { use } from 'flexium/core'
import { Canvas, DrawLine, DrawCircle, DrawText } from 'flexium-canvas/dom'
