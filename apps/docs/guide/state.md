---
title: use() - Unified State Management API
description: Learn how to use Flexium's unified use() API for local state, global state, async data fetching, and computed values.
head:
  - - meta
    - property: og:title
      content: use() API - Flexium State Management
  - - meta
    - property: og:description
      content: Master Flexium's unified use() API - one function for local, global, async, and computed state management.
---

# use()

`use()` is the single, unified API for all state management in Flexium.
