...
/*
  Automatic JSX Reactivity Demo
  
  This file demonstrates how signals are automatically handled by the JSX runtime.
  No manual effect() calls or .value access in JSX is needed!
*/
