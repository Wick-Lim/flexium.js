...
describe('Canvas Renderer', () => {
  ...
  describe('renderCanvasChildren', () => {
    ...
    it('should handle single child', () => {
      const rect = DrawRect({ x: 10, y: 10, width: 50, height: 30, fill: 'red' });
  ...
  describe('DrawRect', () => {
    ...
    it('should render filled rect', () => {
      const rect = DrawRect({ x: 10, y: 10, width: 50, height: 30, fill: 'blue' });
      renderCanvasChildren(ctx, rect, 100, 100);
    ...
    it('should render stroked rect', () => {
      const rect = DrawRect({ x: 5, y: 5, width: 40, height: 20, stroke: 'green', strokeWidth: 2 });
      renderCanvasChildren(ctx, rect, 100, 100);
    ...
    it('should support signal-like values', () => {
      ...
      const rect = DrawRect({ x: x as any, y: y as any, width: 30, height: 20, fill: 'red' });
    ...
    it('should apply opacity', () => {
      const rect = DrawRect({ x: 0, y: 0, width: 10, height: 10, fill: 'red', opacity: 0.5 });
      renderCanvasChildren(ctx, rect, 100, 100);
  ...
  describe('DrawCircle', () => {
    ...
    it('should render stroked circle', () => {
      const circle = DrawCircle({ x: 50, y: 50, radius: 30, stroke: 'orange', strokeWidth: 3 });
  ...
  describe('DrawLine', () => {
    ...
    it('should render line', () => {
      const line = DrawLine({ x1: 10, y1: 20, x2: 80, y2: 90, stroke: 'black', strokeWidth: 2 });
