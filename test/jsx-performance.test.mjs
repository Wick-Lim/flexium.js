...
test('jsx() performance is comparable to h()', () => {
  ...
  // jsx should be reasonably fast (within 3x of h)
  assert.ok(jsxTime < hTime * 3, 'jsx() should be reasonably performant');
});
...
test('jsxs() performance with multiple children', () => {
  ...
  assert.ok(jsxsTime < hTime * 3, 'jsxs() should be reasonably performant');
});
